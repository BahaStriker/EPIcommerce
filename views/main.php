...
<div class="container">
 <div id="carouselExampleIndicators" class="carousel slide marg s" data-ride="carousel">
...
<p class="card-text"><small class="tex"></small></p>
</div>
</div>
<div class="card card-primary">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 brofist">
      <p class="card-text">MEGIR Watch</p>
      <h1>99£</h1>
      <input type="submit" class="btn btn-primary fa fa-cart-plus" name="action" class="fa fa-cart-plus"></input>
    </div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 brofist">
      <p class="card-text">MEGIR Watch</p>
      <h1>99£</h1>
      <input type="submit" class="btn btn-primary " name="action" class="fa fa-cart-plus"></input>
    </div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 brofist">
      <p class="card-text">MEGIR Watch</p>
      <h1>99£</h1>
      <input type="submit" class="btn btn-primary" name="action"  class="fa fa-cart-plus"><span></span></input>
    </div>
